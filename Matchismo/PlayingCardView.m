...
-(void)drawCorners
{
    ...
    UIFont *cornerFont = [UIFont systemFontOfSize:self.bounds.size.width * FONT_SIZE_SCALE];
                          ...
                          upsideDown:(BOOL)upsideDown
{
    ...
    UIFont *pipFont = [UIFont systemFontOfSize:self.bounds.size.width * FONT_SIZE_SCALE];
